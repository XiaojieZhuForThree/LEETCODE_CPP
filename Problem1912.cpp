...
public:
    vector<std::set<std::pair<int, int>>> available = vector<std::set<std::pair<int, int>>> (10010);            
    vector<std::set<std::pair<int, int>>> getPrice = vector<std::set<std::pair<int, int>>> (10010);
